...
<html>
    ...
    <body>
        <div class=startUpPage>
           <form id="signin-form">
           <div class= signin>
           <div><img src="308Vikings/css/viking.png"></div>
              ...
              <div id=appPage> 
                <div class=menu>
                  ...
                  <div class=menutabs id=browserTabs>
                    <ul>
                      <li>
                        <img id=logo src=308Vikings/css/viking.png></img>
                      </li> 
                      <b>
                      <li><a>Browse</a></li>
                      </b>       
                  ...
                  <div id=playlistTabs>
                    <ul>
                      <li>PLAYLISTS</li>
                      <li class=newPlaylist><img style="width: 20px" src="308Vikings/css/add-3.png"> New Playlist</li> 
                    </ul>
                  </div>
                </div>
                ...
                <div class=browse>
                  ...
                  <div class=topnav-bar>
                    ...
                    <div id=user-buttons>
                      <ul>
                        ...
                        <li id=user-display-img><img src=308Vikings/css/user-4.png></img></li>
                  ...
                  <div class="pages" id=playListPage>
                    <div>
                      <img style="margin-top: 0"class=playlistimg src="308Vikings/css/music-player-3.png">
                    ...
                    <div class="container">
                      ...
                      <hr class="style14">
                        ...
                        <table class=songtable>
                          ...
                          <tr>
                            <td><img class='play-btn' src=308Vikings/css/play-button-1.png></img></td>
                        ...
                        <h3>Albums</h3>            
                          <div class=albumitems style="margin-bottom: 7%;">
                            <div>
                            <img class=albumimg src="308Vikings/css/album/MiGente.jpg"></img>
                            <li class=albumname>Mi Gente Feat. Beyonce</li>
                            <li class=albumartist>J Balvin, Willy William</li>     
                            </div>
                            <div>
                            <img class=albumimg src="308Vikings/css/album/TellMeYouLoveMe.png"></img>
                            <li class=albumname>Tell Me You Love Me</li>
                            <li class=albumartist>Demi Lovato</li>     
                            </div>
                            <div>
                            <img class=albumimg src="308Vikings/css/album/TheBiggerArtist.jpg"></img>
                        ...
                        <h3>Playlist</h3>
                          <div class=playlistitems style="margin-bottom:7%">
                            <div>
                              <img class=albumimg src="308Vikings/css/music-player-2.png"></img>
                    ...
                    <div class="container">
                      ...
                      <hr class="style14">
                        <div class=artistitems>
                          <div>
                            <img class=artistimg src="308Vikings/css/artist/jbalvin.jpg"></img>
                            <li class=artistname>J Balvin</li>
                            <li class=songnumber>1 Songs</li>     
                          </div>
                          <div>
                            <img class=artistimg src="308Vikings/css/artist/demilovato.jpg"></img>
                            <li class=artistname>Demi Lovato</li>
                            <li class=songnumber>2 Songs</li>     
                          </div>
                          <div>
                            <img class=artistimg src="308Vikings/css/artist/aboogiewitdahoodie.jpg"></img>
                  ...
                  <div class=pages id=concertpage>
                    <div class="container">
                      ...
                      <table class=concerttable>
                        <tr>
                          <td><img class=concert-btn src=308Vikings/css/user-7.png></img></td>
                          <td>Nas</td>
                          <td>Mon Oct 18</td>
                    ...
                    <div class="container">
                      ...
                      <div id="musictab-1" class="musictab-content current">
                        <div class=albumitems>
                          ...
                          <div>
                          <img class=albumimg src="308Vikings/css/album/NowDeluxe.png"></img>
                          <li class=albumname>Now (Deluxe)</li>
                          <li class=albumartist>Shania Twain</li>     
                          </div>
                          <div>
                          <img class=albumimg src="308Vikings/css/album/YoungerNow.png"></img>
                          <li class=albumname>Younger Now</li>
                          <li class=albumartist>Miley Cyrus</li>     
                          </div>
                          <div>
                          <img class=albumimg src="308Vikings/css/album/savagethank.jpg"></img>
                  ...
                  <div class=pages id=libindivAlbumPage>
                    <div>
                      ...
                      <img style="margin-top: 10px;" class=albumimg src="308Vikings/css/album/MiGente.jpg"></img>   
                    </div>
                  ...
                  <div class=pages id=indivAlbumPage>
                    ...
                    <hr class="style14" style="width:70%">
                      <div class=albumitems>
                          <div>
                          <img class=albumimg src="308Vikings/css/album/energia.jpg"></img>
                          ...
                          <div>
                          <img class=albumimg src="308Vikings/css/album/lafamilia.jpg"></img>
                  ...
                  <div class=pages id=libindivArtistPage>
                    <div>
                      ...
                      <img style="margin-top: 10px;" class=artistimg src="308Vikings/css/artist/jbalvin.jpg" style="margin-bottom: 30px"></img>    
                    </div>
                    <div style="margin-left: 50px; margin-top: 20px; margin-bottom: 10px;">
                  ...
                  <div class=pages id=indivConcertPage >
                    <div style="float: left;"">
                      <img style="float: left; width: 150px" class=concertdateimg src=308Vikings/css/calendar-4.png>
