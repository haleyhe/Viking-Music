             ...
             <div id='feedback'>
                ...
                <div class=browse>
                  ...
                  <div class="ad" ng-style="premium && {'height' : '50px'} || {}">
                    ...
                    <div ng-hide="premium" style="text-align: center; font-size: 50px; color: white; line-height: 200px;"><b>FAR BEYOND</b><sub style="font-size: 16px"><b>STONY BROOK UNIVERSITY</b></sub></div>
                  </div>
